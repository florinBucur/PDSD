...
public class LifecycleMonitorActivity extends Activity {
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState){
    	if ((savedInstanceState != null)) {
        	Log.d(Constants.TAG,"A mai fost apelata");
        	...
        	Log.d(Constants.TAG,"Prima data");
        }
    ...
    protected void onSaveInstanceState(Bundle saved){
    	...
    	if(remember.isChecked()){
    		saved.putBoolean("remember", true);
    	
    		EditText user = (EditText)findViewById(R.id.username_edit_text);
    		EditText pass = (EditText)findViewById(R.id.password_edit_text);
    		saved.putString("user", user.getText().toString());
    		saved.putString("pass", pass.getText().toString());
    	}
    }
